defmodule BasicBlockchain do
   ...
   def generate_genesis_block do
      struct(%BasicBlockchain{}, %{data: "Genesis Block"})
      |> generate_block_hash([])
   end
   ...
   def generate_next_block(blockdata, blockchain) do
        ...
        struct(%BasicBlockchain{}, index: next_index, timestamp: next_timestamp, previousHash: previous_block.hash, data: blockdata )
...
# ts_bl1 = BasicBlockchain.generate_next_block(transaction_data2, blockchain)
...
# block = BasicBlockchain.create(%{b | hash: h})
# transaction_data = %{sender: "Ikumi", recepient: "Woodson", amount: 35, payment: "Debit" }
